 ...
 *
 */
MatrixMul *newMatrixMul(int *err);
 ...
 *
 *  The multiplication must be performed entirely on the server. All
 *  IPC must be handled using POSIX shared memory with POSIX semaphores
